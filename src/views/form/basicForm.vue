  ...
  methods: {
    handleSubmit(e) {
      ...
      this.form.validateFieldsAndScroll((err, values) => {
        if (!err) {
          this.$message.success("Received values of form: ", values);
        }
      });
    },
    handleConfirmBlur(e) {
  ...
  render() {
    ...
    return (
      <a-form onSubmit={this.handleSubmit}>
        <a-form-item {...{ props: formItemLayout }} label="E-mail">
        ...
        <a-form-item {...{ props: formItemLayout }} label="Password">
        ...
        <a-form-item {...{ props: formItemLayout }} label="Confirm Password">
        ...
        <a-form-item {...{ props: formItemLayout }} label="Habitual Residence">
        ...
        <a-form-item {...{ props: formItemLayout }} label="Phone Number">
        ...
        <a-form-item {...{ props: formItemLayout }} label="Website">
...
export default {
  ...
  components: {
    Form: Form.create()(RegistrationForm)
  }
};
</script>
